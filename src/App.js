...
//probably add express routing for the page 
const lightMode = false;
function checkBox(props) {
  if (lightMode) {
    return <div><input type="checkbox" id="termAccept" /><label for="termAccept">I agree to forfeit my immortal soul</label></div>
  }
  else {
    return <div><input type="checkbox" id="termAccept" /><label for="termAccept">I accept the terms and conditions</label></div>
  }
}
function App() {
  return (
    <div className="App">
      <header className="App-header">
        <h3>
          Ẅ̷̹̞̣̠͍͔͈͔̤̟́͛͊͊̕͘͜ͅe̶̮̰͙̟̲̬͕͋͋̀̓̄́̚͝͠͝͝l̷̡̳̳͖͓͗́̄̒̍̏̚͠c̵͈̟͇͓̞̝͈̯̿͌̈́́̕o̴̢̧̹͚̠̹̱̰͑m̶̭̋̔̈͊̏̕e̷̪͋͋͛̑͗̋͒̇̕͝ ̵̻͎͚͔̻͖̹̣̭͉̮̫̝͕͆̓̒́̎̉̕̚t̴̨̼͓̜̙̦̯̠̞̏̈́͌̾̓͂̎̍͑͗͐̍͝o̶̡͍̬̮͆͠ ̶̡̛̖̺͗̄͐͐͝c̴̯̞̺̲͛̒̇̐̈̏ó̷͙̘̦̪̰͚̞̮̳̈̋̋̄̄͑͠ḃ̴̧̦̥̭̗̻͉̜͙̥̜̬̊͊͗̅̚'̷̢̼͎͖̝̺̹̥͈̫̆̋̍̇̄̔͐̇̊̚s̶̪̗̲͒̽̊͂̉͊̇̚
        </h3>
      </header>
      <div className="restOfApp">
        ...
        <div className="terms">
          <form action="/index.js">
            <p><label for="w3review">Privacy Policy</label></p>
            <textarea className="textarea" cols="5" rows="5" >
        ...
        <div className="moreShoes">
          <img className="shoeIcon" src='C:\Users\Connor\Desktop\College\Dark_Patterns\ConsentAtCobs\my-app\src\alsoOld.jpg' alt='devil shoe' width="100" height="100"></img>
